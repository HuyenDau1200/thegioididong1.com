            ...
            <div class="section" id="detail-page">
                <div class="section-detail">
                    <form method="POST" enctype="multipart/form-data">
                        ...
                        <textarea name="desc" id="desc" class="ckeditor"><?= $infoProduct['productDesc'] ?></textarea>
                        <label for="detail">Chi tiết</label>
                        <textarea name="detail" id="detail" class="ckeditor"><?= $infoProduct['productDetail'] ?></textarea>
                        <label>Hình ảnh</label>
                        <div id="uploadFile">
                            <input type="file" name="file" id="upload-thumb" value="<?= $infoProduct['productThumb'] ?>" onchange="chooseFile(this)">
                        ...
                        <button type="submit" name="btn-update" id="btn-submit">Chỉnh sửa</button>
