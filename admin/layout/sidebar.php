    ...
    <ul id="sidebar-menu">
        <li class="nav-item">
            ...
            <ul class="sub-menu">
                ...
                <li class="nav-item">
                    <a href="?mod=page" title="" class="nav-link">Danh sách các trang</a>
                </li>
            </ul>
        </li>
        <li class="nav-item">
            ...
            <ul class="sub-menu">
                ...
                <li class="nav-item">
                    <a href="?mod=post" title="" class="nav-link">Danh sách bài viết</a>
                </li>
                <li class="nav-item">
                    <a href="?mod=post&controller=cat&action=indexCat" title="" class="nav-link">Danh mục bài viết</a>
                </li>
            </ul>
        </li>
        <li class="nav-item">
            ...
            <ul class="sub-menu">
                <li class="nav-item">
                    <a href="?mod=product" title="" class="nav-link">Thêm mới</a>
                </li>
                <li class="nav-item">
                    <a href="?mod=product" title="" class="nav-link">Danh sách sản phẩm</a>
                </li>
                <li class="nav-item">
                    <a href="?mod=category" title="" class="nav-link">Danh mục sản phẩm</a>
                </li>
                <li class="nav-item">
                    <a href="?mod=manufacturer" title="" class="nav-link">Danh sách nhà cung cấp</a>
                </li>
                <li class="nav-item">
                    <a href="?mod=color" title="" class="nav-link">Danh sách màu sắc</a>
                </li>
            </ul>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item">
            ...
            <ul class="sub-menu">
                ...
                <li class="nav-item">
                    <a href="?mod=slider" title="" class="nav-link">Danh sách slider</a>
                </li>
            </ul>
        </li>
        <li class="nav-item">
