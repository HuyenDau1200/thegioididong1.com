...
//Khi chưa login => cố tình truy cập vào hệ thống => chặn lại và điều hướng sang trang login

/* if(!is_login() && get_action() != 'login' && get_action() != 'reg' && get_action() != 'login' && get_action() != 'loss_pass' ){
